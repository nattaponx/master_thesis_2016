...
Similar work has been done but the case was with class diagrams which is a bit different since Elektra has logical components instead of classes \todo{I think this is not done yet}.
